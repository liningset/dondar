  ...
  function validate() {
    ...
    if (
      ...
      if (!checkLackOfPlainDuplicate) {
        helpers.haltMessage(opInfo, "duplicate characters are not allowed in plaintext field");
      }
      if (!checkLackOfCipherDuplicate) {
        helpers.haltMessage(opInfo, "duplicate characters are not allowed in ciphertext field");
      }
      return false;
    }
  }
